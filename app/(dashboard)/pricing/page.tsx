    ...
    <main className="bg-[radial-gradient(circle_at_top,_rgba(20,184,166,0.14),_transparent_28%),linear-gradient(180deg,#fbfffe_0%,#ffffff_34%,#f8fafc_100%)]">
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
        ...
        <div className="mt-8 text-center text-sm font-medium text-slate-600">
          Evidence-backed diagnosis · Clear weekly focus · Compare-ready
          follow-through · Secure checkout powered by Freemius
        </div>
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-3">
          {plans.map((plan) => (
            <article
              key={plan.priceId}
              className={`relative flex h-full flex-col overflow-hidden rounded-[2rem] border bg-white/95 p-8 shadow-[0_18px_60px_rgba(15,23,42,0.08)] ${
                plan.featured
            ...
            >
              ...
              <ul className="mt-8 flex-1 space-y-4 text-lg text-slate-700">
